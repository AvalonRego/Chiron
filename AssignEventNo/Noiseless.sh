...
#SBATCH --array=1-67 # Update based on total chunks
...
python_script="/u/arego/Project/AssignEventNo/noiseless.py"
csv_file="/u/arego/Project/HiWi/Track_skiplist.csv"  # Path to your CSV file
files_per_chunk=300
...
file_list="/u/arego/Project/AssignEventNo/assign/file_list_$SLURM_ARRAY_TASK_ID.txt"
