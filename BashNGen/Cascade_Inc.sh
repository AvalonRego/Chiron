...
dir="/u/arego/Project/LargeCascades/20records/"  # Change this to your directory path
if [ ! -d "$dir" ]; then
...
file="/u/arego/Project/olympus/lib/python3.10/site-packages/olympus/constants.py"  # Change to the correct path
