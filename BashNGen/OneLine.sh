...
script1_path="/u/arego/Project/BashNGen/OneLineInc.sh"  # Update with the correct path if needed
...
python_script="OneLine.py"  # Set the name of your Python script here (e.g., generateTrack.py, another_script.py)
