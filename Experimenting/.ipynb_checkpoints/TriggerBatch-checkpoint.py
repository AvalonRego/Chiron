...
class TriggerDatasetProcessor:
    ...
    def process_records_in_batches(self, batch_size=10):
        """
        Processes records in batches to improve performance, computing the number of modules triggered and hits per interval.
        """
        ...
        for i in range(0, len(self.records), batch_size):
            ...
            for record in batch_records:
                ...
                print(f'time taken by record: {time.time() - time_per_record}')
    ...
    def run(self, batch_size=2000):
        ...
        self.load_data()
        NumberOfModsTriggeredPerRec, HitsPerIntervalPerRec, HitTiming = self.process_records_in_batches(batch_size=batch_size)
...
if __name__ == "__main__":
    ...
    NumberOfModsTriggeredPerRec, HitsPerIntervalPerRec, HitTiming = processor.run(batch_size=10)
