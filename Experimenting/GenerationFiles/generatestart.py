...
StartingTrack_generation_configuration = GenerationConfiguration(
...
def larger_dataset_gen(seed):
    try:
        ...
        configuration = DatasetConfiguration(
            ...
            generators=[StartingTrack_generation_configuration],
...
def get_unique_path(seed):
    ...
    path = f'/u/arego/project/Experimenting/data/LargeStarting/20records/{seed}.h5'
    print(seed)
    initialseed=seed
    
    # Check if the file exists
    if os.path.exists(path):
        while os.path.exists(f'/u/arego/project/Experimenting/data/LargeStarting/20records/{seed}.h5'):
            seed += 1
