...
def process_and_save_hdf5(original_file_path, time_interval, skip_files, skip_records):
    ...
    try:
        ...
        with pd.HDFStore(modified_file_path, mode='a') as store:  # 'a' mode allows modifying the file
            ...
            # Generate event truth mapping (Simplified - no noise filtering)
...
if __name__ == "__main__":
    ...
    process_files_parallel(files, time_interval=100, skip_files=skip_files, skip_records=skip_records, num_workers=1)