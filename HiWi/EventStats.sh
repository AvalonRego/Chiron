...
INPUT_DIR="/viper/ptmp/arego/Red_T_7K_1_EN_100"
INTERMEDIATE_DIR="/ptmp/arego/tempRed/"
OUTPUT_FILE="/ptmp/arego/StatsEN_RedT/out.parquet"


python /u/arego/Project/HiWi/EventStats.py \
    "$INPUT_DIR" \
    "$INTERMEDIATE_DIR" \
    "$OUTPUT_FILE" \
