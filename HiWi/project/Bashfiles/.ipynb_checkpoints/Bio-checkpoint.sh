...
script1_path="Cascade_Inc.sh"  # Update with the correct path if needed
...
python_script="generatecascade.py"  # Set the name of your Python script here (e.g., generatecascade.py, another_script.py)
