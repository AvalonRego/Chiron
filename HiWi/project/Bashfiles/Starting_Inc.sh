...
dir="/u/arego/project/Experimenting/data/LargeStarting/20records"  # Change this to your directory path
...
file="/u/arego/olympus/lib/python3.10/site-packages/olympus/constants.py"  # Change to the correct path
...
if [ ! -s "$file" ]; then
    ...
    cp /u/arego/olympus/lib/python3.10/site-packages/olympus/constants_copy.py "$file"
