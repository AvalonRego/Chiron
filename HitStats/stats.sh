...
#SBATCH -o ./stats/%j.out  # Standard output file
#SBATCH -e ./stats/%j.err   # Error output file
#SBATCH -D ./
...
python_script="/u/arego/Project/HitStats/hitstats.py"


python "$python_script" /ptmp/arego/LargeBio/4000s/ 
