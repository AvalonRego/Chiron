...
#SBATCH -o ./jobs/Merge/OutC/%A_%a.out
#SBATCH -e ./jobs/Merge/ErrC/%A_%a.err
#SBATCH -D ./
#SBATCH -J Merge
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=32
#SBATCH --array=1-100  # Update based on total chunks
...
# Define paths
input_dir="/viper/ptmp/arego/LargeCascades/"
python_script="/u/arego/Project/Merge/CMerge.py"
files_per_chunk=500
