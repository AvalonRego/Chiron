...
#SBATCH -o ./jobs/Merge/OutT/%A_%a.out
#SBATCH -e ./jobs/Merge/ErrT/%A_%a.err
#SBATCH -D ./
#SBATCH -J Merge
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=8
#SBATCH --array=1-250  # Update based on total chunks
...
# Define paths
input_dir="/viper/ptmp/arego/LargeTracks_full/"
python_script="/u/arego/Project/Merge/TMerge.py"
files_per_chunk=100
