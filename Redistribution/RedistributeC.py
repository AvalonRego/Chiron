...
import time
# Configure logging
logging.basicConfig(filename="redistribute.log", level=logging.INFO, format="%(asctime)s - %(levelname)s - %(message)s")
...
def remove_if_old(file_path):
    ...
    if current_time - last_access_time > 300:  # 600 seconds = 10 minutes
        os.remove(file_path)
...
if __name__ == "__main__":
    ...
    process_files(files, save_path="/viper/ptmp/arego/RC4K1_1",num_workers=32)
