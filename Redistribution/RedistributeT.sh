...
#SBATCH -o ./jobs/Redistribute/OutT/%A_%a.out
#SBATCH -e ./jobs/Redistribute/ErrT/%A_%a.err
#SBATCH -D ./
#SBATCH -J Redistribute
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=4
#SBATCH --array=0-50  # Update based on total chunks
...
# Define paths
input_dir="/viper/ptmp/arego/TMerge7k_1"
python_script="/viper/u/arego/Project/Redistribution/RedistributeT.py"
