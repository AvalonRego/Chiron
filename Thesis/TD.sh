...
INPUT_DIRS=( /viper/ptmp/arego/Red_T_7K)  # Add your input directories here
OUTPUT_DIRS=(/u/arego/Project/HiWi/Trigger_process/Track)  # Corresponding output directories
